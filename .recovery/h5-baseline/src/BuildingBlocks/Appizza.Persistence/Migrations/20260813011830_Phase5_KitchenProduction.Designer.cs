...
namespace Appizza.Persistence.Migrations
{
    ...
    [Migration("20260813011830_Phase5_KitchenProduction")]
    partial class Phase5_KitchenProduction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appizza.Modules.Kitchen.ProductionItem", b =>
                {
                    ...
                    b.ToTable("production_item", "kitchen", t =>
                        {
                            t.HasCheckConstraint("ck_production_item_status", "status in ('awaiting_acceptance','accepted','awaiting_preparation','in_preparation','paused','ready')");
                        });
                });
